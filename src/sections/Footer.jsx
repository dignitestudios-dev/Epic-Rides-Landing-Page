        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center mb-10">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <Link
                href={"https://facebook.com/epicridesapp"}
                className="w-12 h-12 md:w-14 md:h-14 border-2 border-gray-600 rounded-full flex items-center justify-center hover:border-green-400"
              >
                <Facebook size={22} />
              </Link>
              <Link
                href={"https://instagram.com/epicridesapp"}
                className="w-12 h-12 md:w-14 md:h-14 border-2 border-gray-600 rounded-full flex items-center justify-center hover:border-green-400"
              >
                <Instagram />
              </Link>
              <Link
                href={"https://www.tiktok.com/@epicridesapp"}
                className="w-12 h-12 md:w-14 md:h-14 border-2 border-gray-600 rounded-full flex items-center justify-center hover:border-green-400"
              >
                <TikTok />
              </Link>
