    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-2">
          <input
            ...
            className="bg-white text-black placeholder:text-[#727272] rounded-xl w-full p-3 border-2 border-gray-300 mb-6 focus:outline-none focus:ring-2 focus:ring-[#61cb08] focus:border-[#61cb08] transition"
            disabled={loading}
          />
      ...
      {showSuccessModal && (
        ...
        >
          ...
          {/* Modal Content */}
          <div
            className={`relative bg-linear-to-b from-white to-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 overflow-hidden transition-all duration-500 transform ${
              isAnimating
